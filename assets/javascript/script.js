...
var questions = [
  ...
  {
    question:
      "How do you start an if statement for if 1 is strictly equal to 5",
...
timer.addEventListener("click", function () {
  // checking against zero because thats the initial interval time
  if (holdInterval === 0) {
    holdInterval = setInterval(function () {
      ...
      if (secondsLeft <= 0) {
        clearInterval(holdInterval);
        finished();
        // timer display text when it reaches 0
